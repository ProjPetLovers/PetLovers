    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <!-- Formulário -->
                <div class="p-8">
                    <form method="POST" action="{{ route('profile.pet.update', $pet->id_pet) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="especie"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Espécie</label>
                            ...
                            <div>
                                <label for="raca"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Raça</label>
                            ...
                            <div>
                                ...
                                <select id="sexo" name="sexo"
                                    ...
                                    required>
                                    <option value="">Selecione</option>
                                    <option value="M" {{ old('sexo', $pet->sexo) == 'M' ? 'selected' : '' }}>Macho
                                    </option>
                                    <option value="F" {{ old('sexo', $pet->sexo) == 'F' ? 'selected' : '' }}>Fêmea
                                    </option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="peso" name="peso" step="0.01" min="0.1"
                                    max="999.99" value="{{ old('peso', $pet->peso) }}"
                                    class="w-full px-3 py-2 border rounded-md dark:bg-gray-800 dark:text-white"
                                    required>
                            </div>
                            ...
                            <div>
                                <label for="castrado"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Castrado</label>
                                <select id="castrado" name="castrado"
                                    class="w-full px-3 py-2 border rounded-md dark:bg-gray-800 dark:text-white"
                                    required>
                                    <option value="">Selecione</option>
                                    <option value="1"
                                        {{ old('castrado', $pet->castrado) == '1' ? 'selected' : '' }}>Sim</option>
                                    <option value="0"
                                        {{ old('castrado', $pet->castrado) == '0' ? 'selected' : '' }}>Não</option>
                                </select>
                            </div>

                            <!-- Socializa -->
                            <div>
                                <label for="cod_socializa"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Socializa
                                    com</label>
                        ...
                        @if ($pet->foto)
                            <div>
                                ...
                                <div class="flex items-center space-x-4">
                                    @php
                                        // Verifica se é uma URL externa ou arquivo local
                                        $imageSrc = filter_var($pet->foto, FILTER_VALIDATE_URL)
                                            ? $pet->foto
                                            : asset('storage/fotopet/' . $pet->foto);
                                    @endphp
                                    <img src="{{ $imageSrc }}" alt="Foto atual do {{ $pet->nome }}"
                        ...
                        <div>
                            <label for="bio"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Bio do Pet
                                (opcional)</label>
