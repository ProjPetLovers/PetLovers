    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div
                    class="relative p-8"
                    style="@if($userData['fundo_url'])
                        background-image: url('{{ $userData['fundo_url'] }}'); background-size: cover; background-position: center;
                    @else
                        background: linear-gradient(to right, #e3967d, #57342d);
                    @endif">
