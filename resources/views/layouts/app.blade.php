                    ...
                    {{-- Links Desktop --}}
                                        <div class="hidden sm:flex sm:items-center sm:space-x-6">
                                            ...
                                            <x-dropdown align="right" width="48">
                                                <x-slot name="trigger">
                                                    <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-light hover:text-primary focus:outline-none transition ease-in-out duration-150">
                                    ...
                                    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                                        <div class="pt-2 pb-3 space-y-1">
                                            @can('manage-users')
                                                <a href="{{ route('admin.users.index') }}" class="block px-3 py-2 text-light hover:text-primary">
                                                    {{ __('Gerenciar Usuários') }}
                                                </a>
                                            @endcan
                                            ...
                                            <form method="POST" action="{{ route('logout') }}">
                                                @csrf
                                                <button type="submit" class="block w-full text-left px-3 py-2 text-light hover:text-primary">
                                                    {{ __('Sair') }}
                                                </button>
                                            </form>
                                        </div>
