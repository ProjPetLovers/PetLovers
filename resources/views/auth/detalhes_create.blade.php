        ...
        <form method="POST" action="{{ route('detalhes.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <label for="foto" class="block mt-1 w-full cursor-pointer bg-[#f7e3b2] border-[#f28a49] text-[#f28a49] font-semibold py-2 px-4 rounded-md shadow-sm hover:bg-[#f28a49] hover:text-white transition text-center">
                        Escolher arquivo
                ...
                <div>
                    ...
                    <label for="photo_fundo" class="block mt-1 w-full cursor-pointer bg-[#f7e3b2] border-[#f28a49] text-[#f28a49] font-semibold py-2 px-4 rounded-md shadow-sm hover:bg-[#f28a49] hover:text-white transition text-center">
                        Escolher arquivo
